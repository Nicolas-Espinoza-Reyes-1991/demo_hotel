      ...
      <main className="mx-auto max-w-7xl px-4 py-4 pb-24 sm:px-6 sm:py-6 sm:pb-28">
        <div className="booking-shell space-y-4 sm:space-y-5">
          <div className="booking-hero-panel animate-fade-in-up space-y-4 sm:space-y-5">
            <section className="space-y-2" aria-labelledby="booking-home-title">
              ...
              <h1
                id="booking-home-title"
                className="max-w-2xl text-2xl font-extrabold tracking-tight text-brand-100 sm:text-3xl lg:text-[2rem]"
              >
          ...
          <section aria-label="Habitaciones disponibles">
